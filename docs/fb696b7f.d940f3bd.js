  ...
  [17],
  {
    87: function (e, t, r) {
      ...
      var n = r(3),
        o = r(7),
        a = (r(0), r(90)),
        s = { id: 'stores', title: 'Formula Stores', sidebar_label: 'Formula Stores' },
        i = {
          unversionedId: 'stores/stores',
          id: 'stores/stores',
          isDocsHomePage: !1,
          title: 'Formula Stores',
          description: 'Accessing Stores',
          source: '@site/docs/stores/stores.md',
          slug: '/stores/stores',
          permalink: '/docs/stores/stores',
          version: 'current',
          sidebar_label: 'Formula Stores',
          sidebar: 'someSidebar',
          previous: { title: 'Formula Lifecycle', permalink: '/docs/lifecycle' },
          next: { title: 'dirty', permalink: '/docs/stores/stores-dirty' },
        },
        c = [
          { value: 'Accessing Stores', id: 'accessing-stores', children: [] },
          { value: 'Global Store', id: 'global-store', children: [] },
        ],
        l = { toc: c };
      function u(e) {
        var t = e.components,
        ...
        return Object(a.b)(
          ...
          Object(a.b)('h2', { id: 'accessing-stores' }, 'Accessing Stores'),
          Object(a.b)(
            'p',
            null,
            'Formula provides a set of Svelte ',
            Object(a.b)('a', { parentName: 'p', href: 'https://svelte.dev/docs#svelte_store' }, 'stores'),
            ' as part of each instance created\nwith ',
            Object(a.b)('inlineCode', { parentName: 'p' }, 'formula()'),
            '. These stores provide different types of values at different lifecycles of your application.',
          ),
          Object(a.b)(
            'p',
            null,
          ...
          Object(a.b)('h2', { id: 'global-store' }, 'Global Store'),
          Object(a.b)(
            'p',
            null,
            'When attaching a form to an element, if you provide an ',
            Object(a.b)('inlineCode', { parentName: 'p' }, 'id'),
            ' property the stores will be added to a global ',
            Object(a.b)('inlineCode', { parentName: 'p' }, 'Map'),
      ...
      var l = o.a.createContext({}),
        ...
        f = o.a.forwardRef(function (e, t) {
          var r = e.components,
            ...
            p = u(r),
            f = n,
            b = p[''.concat(s, '.').concat(f)] || p[f] || m[f] || a;
          return r
            ? o.a.createElement(b, i(i({ ref: t }, l), {}, { components: r }))
            : o.a.createElement(b, i({ ref: t }, l));
        });
      function b(e, t) {
        var r = arguments,
          n = t && t.mdxType;
        if ('string' == typeof e || n) {
          ...
          (i.originalType = e), (i.mdxType = 'string' == typeof e ? e : n), (s[1] = i);
          for (var l = 2; l < a; l++) s[l] = r[l];
          return o.a.createElement.apply(null, s);
        }
