  ...
  [8],
  {
    77: function (e, t, r) {
      ...
      var n = r(3),
        o = r(7),
        a = (r(0), r(90)),
        i = { id: 'stores-touched', title: 'touched', sidebar_label: 'touched' },
        c = {
          unversionedId: 'stores/stores-touched',
          id: 'stores/stores-touched',
          isDocsHomePage: !1,
          title: 'touched',
          description: 'Description',
          source: '@site/docs/stores/touched.mdx',
          slug: '/stores/stores-touched',
          permalink: '/docs/stores/stores-touched',
          version: 'current',
          sidebar_label: 'touched',
          sidebar: 'someSidebar',
          previous: { title: 'submitValues', permalink: '/docs/stores/stores-submit-values' },
          next: { title: 'validity', permalink: '/docs/stores/stores-validity' },
        },
        s = [
      ...
      function u(e) {
        ...
        return Object(a.b)(
          ...
          Object(a.b)(
            'p',
            null,
            'This store provides the touched status of a field, or group of fields under a single ',
          ...
          Object(a.b)(
            ...
            Object(a.b)('inlineCode', { parentName: 'p' }, 'focus'),
            ' handler. The touched status for the group ',
            Object(a.b)('inlineCode', { parentName: 'p' }, 'name'),
            ' is also set to ',
          ...
          Object(a.b)(
            'p',
            null,
            'When the user clicks or tabs on to the field the store is updated to reflect the ',
            Object(a.b)('inlineCode', { parentName: 'p' }, 'name'),
            ' as ',
      ...
      var l = o.a.createContext({}),
        ...
        f = o.a.forwardRef(function (e, t) {
          var r = e.components,
            ...
            p = u(r),
            f = n,
            b = p[''.concat(i, '.').concat(f)] || p[f] || d[f] || a;
          return r
            ? o.a.createElement(b, c(c({ ref: t }, l), {}, { components: r }))
            : o.a.createElement(b, c({ ref: t }, l));
        });
      function b(e, t) {
        var r = arguments,
          n = t && t.mdxType;
        if ('string' == typeof e || n) {
          ...
          (c.originalType = e), (c.mdxType = 'string' == typeof e ? e : n), (i[1] = c);
