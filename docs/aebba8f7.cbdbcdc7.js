  ...
  [9],
  {
    78: function (e, t, n) {
      ...
      var a = n(3),
        r = n(7),
        o = (n(0), n(90)),
        i = { id: 'options', title: 'Formula Options', sidebar_label: 'Formula Options' },
        l = {
          ...
          sidebar: 'someSidebar',
          previous: { title: 'Formula API', permalink: '/docs/formula' },
          next: { title: 'Formula Lifecycle', permalink: '/docs/lifecycle' },
        },
        s = [
          {
            value: '<code>enrich</code>',
            id: 'enrich',
            children: [
              { value: '<code>messages</code>', id: 'messages', children: [] },
              { value: '<code>validators</code>', id: 'validators', children: [] },
              { value: '<code>formValidators</code>', id: 'formvalidators', children: [] },
            ],
          },
      ...
      function u(e) {
        ...
        return Object(o.b)(
          ...
          Object(o.b)(
            'p',
            null,
            'Formula is zero-configuration - Out-of-the-box - using standard HTML5 validation properties to build up its validation\nrules - however it is also possible to pass custom validation rules via the ',
            Object(o.b)('inlineCode', { parentName: 'p' }, 'formula()'),
            ' options object.',
          ),
          Object(o.b)('h2', { id: 'enrich' }, Object(o.b)('inlineCode', { parentName: 'h2' }, 'enrich')),
          Object(o.b)(
            'p',
            null,
            'The ',
            Object(o.b)('inlineCode', { parentName: 'p' }, 'enrich'),
            ' object is used to pass methods to the Formula instance that allow the generation of computed values for\ncurrent form values - these are added at the field level, and each field can have multiple. All the calculated values\nare available via the ',
            Object(o.b)('a', { parentName: 'p', href: '/docs/stores/stores-enrichment' }, 'enrichment store'),
            '.',
          ),
          Object(o.b)(
            'pre',
          ...
          Object(o.b)('h3', { id: 'messages' }, Object(o.b)('inlineCode', { parentName: 'h3' }, 'messages')),
          Object(o.b)(
            'p',
            null,
            'Used for localisation and custom messages, this is a ',
            Object(o.b)('inlineCode', { parentName: 'p' }, 'Object'),
            ' containing a key that is the field ',
            Object(o.b)('inlineCode', { parentName: 'p' }, 'name'),
            ' to apply the\nmessages to. The value is another ',
            Object(o.b)('inlineCode', { parentName: 'p' }, 'Object'),
            ' that contains the key for each error (e.g. ',
            Object(o.b)('inlineCode', { parentName: 'p' }, 'valueMissing'),
          ...
          Object(o.b)('h3', { id: 'validators' }, Object(o.b)('inlineCode', { parentName: 'h3' }, 'validators')),
          Object(o.b)(
            'p',
            null,
            'An ',
            ...
            ' containing a key that is the field ',
            Object(o.b)('inlineCode', { parentName: 'p' }, 'name'),
            ' to apply the validation to, the value is another object that\ncontains each named validation function. The result are made available in the ',
          ...
          Object(o.b)(
            'h3',
            { id: 'formvalidators' },
            Object(o.b)('inlineCode', { parentName: 'h3' }, 'formValidators'),
          ),
          Object(o.b)(
            'p',
            null,
            'An ',
            Object(o.b)('inlineCode', { parentName: 'p' }, 'Object'),
            ' containing a key that is the name of the validation rule, and the function that returns the validation\nresult. The results are available in the ',
            Object(o.b)('inlineCode', { parentName: 'p' }, 'formValidity'),
            ' store',
          ),
          Object(o.b)('p', null, 'When using custom ', Object(o.b)('inlineCode', { parentName: 'p' }, 'validators')),
      ...
      var c = r.a.createContext({}),
        ...
        m = r.a.forwardRef(function (e, t) {
          var n = e.components,
            ...
            p = u(n),
            m = a,
            b = p[''.concat(i, '.').concat(m)] || p[m] || d[m] || o;
          return n
            ? r.a.createElement(b, l(l({ ref: t }, c), {}, { components: n }))
            : r.a.createElement(b, l({ ref: t }, c));
        });
      function b(e, t) {
        var n = arguments,
          a = t && t.mdxType;
        if ('string' == typeof e || a) {
          ...
          (l.originalType = e), (l.mdxType = 'string' == typeof e ? e : a), (i[1] = l);
          for (var c = 2; c < o; c++) i[c] = n[c];
          return r.a.createElement.apply(null, i);
        }
